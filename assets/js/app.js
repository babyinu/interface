...
const sttaddr = "0x01bdd3b6ddc0efe80631708d0397f670079404db";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x01bdd3b6ddc0efe80631708d0397f670079404db";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://babyinu.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x01bdd3b6ddc0efe80631708d0397f670079404db',
                    'symbol': 'BINU',
                    'decimals': '8',
                    'image': 'https://babyinu.net/uploads/babyinu.png',
                },
            },
