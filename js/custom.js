...
jQuery(document).ready(function(){
	jQuery('#aio_menu_mobile ul li.menu-item-has-children').append("<span>-</span>").addClass('active');
	jQuery(".icon_mobile_click").click(function(){
		jQuery('html').addClass('no_scroll');
		jQuery('.close_menu').fadeIn(300);
		jQuery('.bg_menu_mobile').fadeIn(300);
		jQuery(".icon_mobile_active").fadeIn(300);
		jQuery("#page_wapper").addClass('aio_page_wapper_active');
	...
	jQuery(".close_menu").click(function(){
		...
		jQuery("#page_wapper").removeClass('aio_page_wapper_active');
